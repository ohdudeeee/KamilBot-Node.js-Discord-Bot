...
bot.on('message', async message => {
    ...
    'Można jeszcze założyć jakiś biznes na South Central? Dokładnie dzielnicowy pub "U Shadowa".Szkoda, dodałby nam troszkę klimatu dla dzielnicy i byłoby gdzie zarabiać na gnacisze.',
